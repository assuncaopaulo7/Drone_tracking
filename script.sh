...
gnome-terminal --tab --title="PX4 Avião" -- bash -c 'cd ~/PX4-Autopilot && PX4_SYS_AUTOSTART=4003 PX4_GZ_MODEL_POSE="0,2" PX4_SIM_MODEL=gz_rc_cessna ./build/px4_sitl_default/bin/px4 -i 3; exec bash'
